...
export const PERSONA_AURAS: Record<string, PersonaAura> = {
  ...
  rapid_risk_taker: {
    background: "/aura-backgrounds/bg-rapid-risk-taker-v2.png",
    verticalBackground: "/aura-backgrounds/bg-rapid-risk-taker-vertical.png",
    icon: "/aura-icons/icon-rapid-risk-taker.png",
    alt: "Purple flames and speed lines suggesting bold, fast movement",
    description: "Ships fast, skips guardrails, embraces risk",
  },
  prompt_sprinter: {
    background: "/aura-backgrounds/bg-prompt-sprinter-v2.png",
    verticalBackground: "/aura-backgrounds/bg-prompt-sprinter-vertical.png",
    icon: "/aura-icons/icon-prompt-sprinter.png",
  ...
  fix_loop_hacker: {
    background: "/aura-backgrounds/bg-prompt-sprinter-v2.png",
    verticalBackground: "/aura-backgrounds/bg-prompt-sprinter-vertical.png",
    icon: "/aura-icons/icon-fix-loop-hacker.png",
  ...
  balanced_builder: {
    background: "/aura-backgrounds/bg-reflective-balancer-v2.png",
    verticalBackground: "/aura-backgrounds/bg-reflective-balancer-vertical.png",
    icon: "/aura-icons/icon-balanced-builder.png",
  ...
  reflective_balancer: {
    background: "/aura-backgrounds/bg-reflective-balancer-v2.png",
    verticalBackground: "/aura-backgrounds/bg-reflective-balancer-vertical.png",
    icon: "/aura-icons/icon-reflective-balancer.png",
    alt: "Balance scales and yin-yang suggesting thoughtful equilibrium",
    description: "Thoughtful consideration of tradeoffs",
  },
  guardrailed_viber: {
    background: "/aura-backgrounds/bg-guardrailed-viber-v2.png",
    verticalBackground: "/aura-backgrounds/bg-guardrailed-viber-vertical.png",
    icon: "/aura-icons/icon-guardrailed-viber.png",
  ...
  spec_first_director: {
    background: "/aura-backgrounds/bg-methodical-architect-v2.png",
    verticalBackground: "/aura-backgrounds/bg-methodical-architect-vertical.png",
    icon: "/aura-icons/icon-spec-first-director.png",
  ...
  methodical_architect: {
    background: "/aura-backgrounds/bg-methodical-architect-v2.png",
    verticalBackground: "/aura-backgrounds/bg-methodical-architect-vertical.png",
    icon: "/aura-icons/icon-methodical-architect.png",
  ...
  vertical_slice_shipper: {
    background: "/aura-backgrounds/bg-orchestrator-v5.png",
    verticalBackground: "/aura-backgrounds/bg-orchestrator-vertical.png",
    icon: "/aura-icons/icon-vertical-slice-shipper.png",
  ...
  toolsmith_viber: {
    background: "/aura-backgrounds/bg-orchestrator-factory.png",
    verticalBackground: "/aura-backgrounds/bg-orchestrator-factory-vertical.png",
    icon: "/aura-icons/icon-toolsmith-viber.png",
  ...
  infra_weaver: {
    background: "/aura-backgrounds/bg-orchestrator-factory.png",
    verticalBackground: "/aura-backgrounds/bg-orchestrator-factory-vertical.png",
    icon: "/aura-icons/icon-infra-weaver.png",
  ...
  "agent-orchestrator": {
    background: "/aura-backgrounds/bg-orchestrator-v5.png",
    verticalBackground: "/aura-backgrounds/bg-orchestrator-vertical.png",
    icon: "/aura-icons/icon-orchestrator.png",
